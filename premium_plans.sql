...
CREATE TABLE IF NOT EXISTS premium_plans (
  ...
  price TEXT, -- 'Gratis', '$4.99/mes', '$9.99/mes'
...
INSERT INTO premium_plans (plan_name, display_name, price, color, features, limitations, sort_order) VALUES
  ('free', 'Free', 'Gratis', '#666666',
